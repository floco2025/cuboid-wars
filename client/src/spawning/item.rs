        ...
        return commands
            .spawn(ItemBundle {
                ...
                material: MeshMaterial3d(materials.add(StandardMaterial {
                    base_color_texture: Some(asset_server.load("textures/cookie/albedo.png.ktx2")),
                    normal_map_texture: Some(asset_server.load("textures/cookie/normal-dx.png.ktx2")),
                    occlusion_texture: Some(asset_server.load("textures/cookie/ao.png.ktx2")),
                    metallic_roughness_texture: Some(asset_server.load("textures/cookie/metallic-roughness.png.ktx2")),
    ...
    commands
        .spawn((
            ItemBundle {
                ...
                material: MeshMaterial3d(materials.add(StandardMaterial {
                    base_color_texture: Some(asset_server.load("textures/item/albedo.png.ktx2")),
                    normal_map_texture: Some(asset_server.load("textures/item/normal-dx.png.ktx2")),
                    occlusion_texture: Some(asset_server.load("textures/item/ao.png.ktx2")),
                    metallic_roughness_texture: Some(asset_server.load("textures/item/metallic-roughness.png.ktx2")),
