...
pub fn scene_render_target_system(
    ...
    // The cap is a fullscreen setting: windowed mode has the window size as
    // its one resolution knob.
...
fn scene_image_size(window_physical: UVec2, fullscreen_resolution: u32) -> UVec2 {
    if window_physical.y <= fullscreen_resolution {
