...
use crate::{
    config::SkyConfig,
    constants::{
        SKY_BRIGHT_STAR_FRACTION, SKY_CLOUD_COLOR, SKY_CLOUD_SCALE, SKY_CLOUD_SHADOW_COLOR, SKY_DAY_HORIZON_COLOR,
        SKY_DAY_ZENITH_COLOR, SKY_MOON_APPARENT_RADIUS_DEGREES, SKY_MOON_EARTHSHINE, SKY_MOON_HALO_LUMINANCE,
...
impl ProceduralSkyMaterial {
    ...
    pub fn from_config(config: SkyConfig) -> Self {
        Self {
            ...
            cloud_shadow_color: color(SKY_CLOUD_SHADOW_COLOR, 0.0),
        }
    }
}
