...
use crate::{schedule::ClientSet, ui::console_closed};

// Input writes local intent and view/debug state. Everything but movement
// stands down while the console is open (`console_closed`); movement keeps
...
pub fn input_plugin(app: &mut App) {
    app.add_systems(
        ...
        (
            ...
            input_missile_system.after(input_movement_system).run_if(console_closed),
            ...
            input_cursor_toggle_system
                ...
                .run_if(console_closed),
            input_camera_view_toggle_system.run_if(console_closed),
            input_level_focus_toggle_system.run_if(console_closed),
            input_fullscreen_toggle_system.run_if(console_closed),
            input_debug_colors_cycle_system.run_if(console_closed),
        )
