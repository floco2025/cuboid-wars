...
pub struct PlayerInfo {
    ...
    pub spawn_tick: u32,
    // The number of the saved checkpoint, 0 at the start; the reached cue
    // sets it early and the snapshot keeps it current.
    pub checkpoint: u32,
...
impl PlayerInfo {
    ...
    pub fn apply_checkpoint(&mut self, checkpoint: u32, tick: u32) {
...
impl PlayerMap {
    ...
    // The retired generation outlives the body: a pre-death snapshot can still
    // arrive after the removal and must not recreate it.
