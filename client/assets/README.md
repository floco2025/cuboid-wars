...
- `pressure_plate` — model `scene`, fallback `default_color`, `light_color`, and `emissive_luminance`. Treads inherit barrier/bridge colors or a switch's `color` override.
