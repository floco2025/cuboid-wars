...
3. **Trade height for distance.** On the next terrace, approach the edge above
   ...
   the large checkpoint 3 platform across the void. Get close enough to the
   edge that the floor shot clears its lip. Walk off toward A, release movement
   once centered over it, and let the fall launch you sideways onto checkpoint 3.
