...
pub const OVERLAP_WALLS: bool = false; // Non-overlapping mode by default
pub const MERGE_WALL_SEGMENTS: bool = true; // Reduce draw calls
...
pub const OVERLAP_ROOFS: bool = false; // Non-overlapping mode by default
pub const MERGE_ROOF_SEGMENTS: bool = true; // Reduce draw calls
