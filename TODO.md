...
- **Third-person camera:** Check V toggling top-down and restoring the previous zoom, scrolling between first and third person with lock enabled on entering first person, F lock (Ctrl/Cmd+F only changes fullscreen), mouse orbit in both states without holding a button, saved zoom sensitivity, movement while unlocked, cursor restoration after menus and Shift-Escape, fine mouse and zoom sensitivity below 1, saved multipliers and logarithmic slider positions, initial first-person zoom without a model flash, body visibility and first-person snapping at the same cutoff (including obstructions), and the shared first/third-person/rearview FOV setting. Check narrow Hotel corridors, ceilings, moving carriers, respawns, portal travel, and projectiles/portal shots/missile locks at the crosshair near cover, including firing while moving sideways in free orbit. The user handles in-game testing.
...
- **Character capsules and hitboxes:** Retest smooth walking, running, and speed-power-up movement throughout Hotel after the capsule contact fix, including floor joins and reconciliation snaps. Check slope and step limits, natural edge overhang, jumps, actor clearance and contact attacks, ladders, moving-platform boarding/pushing/crushing, portals, and erasers. Cycle B through Off, Grounding, and Hitbox; check rotating damage boxes, grounding contact indicators and Grounded/Airborne/Ladder labels, including after respawn and portal travel. Grounding includes the movement capsule; check smooth debug motion while walking/running and on carriers, independent of model animation and hit shake. Cycling views shows no banner. Movement and hitbox sizes are independent in gameplay.json. The user handles in-game testing.
