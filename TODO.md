...
- **Nested `use` statements without renames:** Merge every file's imports into nested `use` trees wherever possible, and drop `use ... as` renames unless a name collision leaves no alternative.
