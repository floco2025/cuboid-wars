...
Cuboid Wars is a networked 3D game where players navigate a procedurally-generated maze, collect cookies for points, gather power-ups, and avoid sentries. The game features physics-based projectiles with collision detection, a client-server architecture with authoritative server logic, and client-side prediction for smooth gameplay.
