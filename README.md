...
Client visuals are configured through the hand-edited JSON asset set at `client/assets/default.json`, including material rules that use editor coordinates for floors and walls.
