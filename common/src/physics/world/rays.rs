use bevy_math::Vec3;
use rapier3d::prelude::{ColliderHandle, Group, Ray};

use super::{
    CollisionWorld,
    colliders::{
        ColliderKind, WALL_COLLISION_GROUP, character_collision_groups, ground_collision_groups, query_filter,
...
impl CollisionWorld {
    ...
    fn surface_along_ray(
        ...
        let (handle, hit) =
            self.query_pipeline(query_filter(groups))
