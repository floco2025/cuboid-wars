...
// the collision world, switched carriers by the runs the plate state
// carries. Both sides run it right before character movement: a jump probe
// earlier in the tick still sees the carriers where the bodies were left
